...
namespace std {
	...
	template <>
	struct is_error_code_enum<curl::native::CURLcode> : public true_type {};
	template <>
	struct is_error_code_enum<boost::asio::error::basic_errors> : public true_type {};
}  // namespace std
...
#define IMPLEMENT_CURL_OPTION(FUNCTION_NAME, OPTION_NAME, OPTION_TYPE) \
	...
	{ \
		...
		throw_error(ec, BOOST_PP_STRINGIZE(FUNCTION_NAME)); \
	} \
